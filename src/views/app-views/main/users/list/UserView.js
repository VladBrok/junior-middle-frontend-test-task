  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Divider dashed />
        <div className="">
          <h6 className="text-muted text-uppercase mb-3">Данные аккаунта</h6>
          <p>
            <UserOutlined />
          ...
          <p>
            ...
            <span className="ml-3 text-dark">
              Дата рождения: {data?.personalInfo.birthday || "-"}
            </span>
          </p>
        </div>
        <div className="mt-5">
        ...
        <div className="mt-5">
          <h6 className="text-muted text-uppercase mb-3">Социальные сети</h6>
          <p>
            <FacebookOutlined />
